...
Let's look at a short example testing spans. Spans have a lifetime where they are created, enter and exit - perhaps multiple times, and then get closed. The only point at which we can check many of a span's attributes is when it is created.
